    ...
    <>
      <Row xs={1} md={2} lg={3} className="g-4">
        ...
        <Col>
          ...
          >
            <Card.Body>
              <Card.Title className="project-title">Add New Project</Card.Title>
      ...
      <Modal show={showModal} onHide={handleCloseModal} centered>
        ...
        <Modal.Body className="modal-body-custom">
          <Form>
            ...
            <Form.Group controlId="formNewProjectDescription" className="mt-3">
        ...
        <Modal.Footer style={{ backgroundColor: "#1e1e1e", border: "none" }}>
          <Button
            variant="secondary"
